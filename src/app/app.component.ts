...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.updateMetaTags({
      title: 'Gaurav Nishad | Full-Stack Developer | Angular & .NET Expert | Portfolio',
      ...
      keywords: 'Gaurav Nishad, Full-Stack Developer, Angular Developer, .NET Developer, TypeScript Expert, Web Development, JavaScript, Node.js, Software Engineer, Frontend Developer, Backend Developer, Portfolio'
    });
