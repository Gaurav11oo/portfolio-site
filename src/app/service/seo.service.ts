...
export class SeoService {
  ...
  private siteName = "Gaurav Nishad";
      ...
      .subscribe((route) => {
        ...
        if (routeData) {
          ...
          this.updatePageMetadata({
            title: routeData["title"] || "Gaurav Nishad | Full-Stack Developer | Portfolio",
  ...
  updatePageMetadata(metadata: PageMetadata): void {
    ...
    const formattedTitle =
      metadata.title === "Home" ? "Gaurav Nishad | Full-Stack Developer" : `${metadata.title} – ${this.siteName}`;
  ...
  updateTitle(title: string): void {
    const formattedTitle = title === "Home" ? "Gaurav Nishad | Full-Stack Developer" : `${title} – ${this.siteName}`;
    this.title.setTitle(formattedTitle);
  }
  ...
  updateSeoForRoute(route: string, metadata: Partial<PageMetadata>): void {
    ...
    this.updatePageMetadata({
      title: metadata.title || "Gaurav Nishad | Full-Stack Developer | Portfolio",
